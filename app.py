...
def sendMail():
    ...
    li = ["pushparajcoder@gmail.com", "geniusadarsh3@gmail.com"]
    ...
    toaddr = "geniusadarsh3@gmail.com"
    msg['To'] = toaddr
    ...
    body = "Reminder to check the storage status of the system for the user"
    ...
    #     s = smtplib.SMTP('smtp.gmail.com', 587)
    #     s.starttls()
    #     s.login("sdashadm@gmail.com", "mvfkqncnorepjfjp")
    #     message = "Hello world"
    #     s.sendmail("sdashadm@gmail.com", dest, message)
    #     s.quit()
